...
mod tests {
    ...
    fn test_new() {
        ...
        let contract =
            Contract::new_default_meta(accounts(1), TOTAL_SUPPLY.into(), "SYMBOL".into(), 24);
    ...
    fn test_transfer() {
        ...
        testing_env!(context.build());
        let mut contract =
            Contract::new_default_meta(accounts(2), TOTAL_SUPPLY.into(), "SYMBOL".into(), 24);
        testing_env!(context
