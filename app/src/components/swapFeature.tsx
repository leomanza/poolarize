      ...
      {step === 1 ? (
        <>
          <div className="space-y-2">
            ...
            <Select.Root onValueChange={(value) => setFromToken(tokens.find(t => t.name === value) || tokens[0])}>
        ...
        <>
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-[#DADDF1]/80">Price: 1 {mainToken.name} = ${mainToken.price}</p>
          </div>
